import { DollarSign, PiggyBank, CreditCard, Zap, Activity, CreditCard as Wallet, Settings, TrendingUp } from 'lucide-react';
...
export const transactionsData: Transaction[] = [
  { name: 'Starbucks Coffee', amount: -5.40, roundup: 0.60, time: '2 hours ago', category: 'food' },
  { name: 'Amazon Purchase', amount: -89.99, roundup: 0.01, time: '1 day ago', category: 'shopping' },
  { name: 'Salary Deposit', amount: 4250.00, roundup: 0, time: '2 days ago', category: 'income' },
  { name: 'Gas Station', amount: -45.23, roundup: 0.77, time: '3 days ago', category: 'transport' },
  { name: 'Netflix', amount: -15.99, roundup: 0.01, time: '5 days ago', category: 'entertainment' }
];
